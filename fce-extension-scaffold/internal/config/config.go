...
const (
	// Bump this whenever handler behavior or the onchain interface changes —
	// the TEE registration path treats code version as part of the
	// extension lifecycle.
	Version = "0.1.0"

	OPTypeIncidentTriage      = "INCIDENT_TRIAGE"
	OPCommandClassifySeverity = "CLASSIFY_SEVERITY"
